...
const float THIRD_PERSON_FOCUS_DISTANCE	= 100.0f;//512.0f;
...
// PHIL BEGIN
	idUserInterface *  statsGui;
   idUserInterface *  invGui;
   idUserInterface *  mapGui;
   ...
   bool startMapGui;
	  ...
	  idUserInterface *      statsUI;
   bool               statsUIopen;
   bool               statsDebug;   
   void               OpenStats( idStr nextMap, int level_no );  
   void               StatsProceed();   
   void               ClearStats();   
   void               ToggleStatsDebug();
...
// PHIL END
	...
	bool					lastHitToggle;
// PHIL BEGIN
	idEntityPtr<idLight>   Mountedflashlight;
// PHIL END
	bool					forcedReady;
