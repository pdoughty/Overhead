...
// PHIL BEGIN
	cmdSystem->AddCommand( "statsGui", idGameLocal::StartStatsGui_f, CMD_FL_GAME,"pops up your stats." ); 
   cmdSystem->AddCommand( "invGui", idGameLocal::StartInvGui_f, CMD_FL_GAME, "pops up your inventory." ); 
   cmdSystem->AddCommand( "mapGui", idGameLocal::StartMapGui_f,  CMD_FL_GAME, "pops up the game map." );
   //cmdSystem->AddCommand( "interact", idItem::Interact_f, CMD_FL_GAME, "Interacts with Items." );
