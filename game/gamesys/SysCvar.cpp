...
// server info
idCVar s_driver( "s_driver", "0", CVAR_GAME | CVAR_INTEGER, "Just to keep the console quiet on Windows", 0, 2 );
...
idCVar pm_minviewpitch(				"pm_minviewpitch",			"0",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "amount player's view can look up (negative values are up)" );
idCVar pm_maxviewpitch(				"pm_maxviewpitch",			"0",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "amount player's view can look down" );
...
idCVar pm_thirdPersonRange(			"pm_thirdPersonRange",		"0",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "camera distance from player in 3rd person" );
idCVar pm_thirdPersonHeight(		"pm_thirdPersonHeight",		"350",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "height of camera from normal view height in 3rd person" );
