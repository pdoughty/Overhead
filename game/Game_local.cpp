...
/*
================
idGameLocal::StartStatsGui_f
================
*/
void idGameLocal::StartStatsGui_f( const idCmdArgs& args ) {
   idPlayer *player;
...
/*
================
idGameLocal::StartInvGui_f
================
*/
void idGameLocal::StartInvGui_f( const idCmdArgs& args ) {
   idPlayer *player;
   player = gameLocal.GetLocalPlayer();
    player->ToggleInv();
}
...
/*
================
idGameLocal::StartMapGui_f
================
*/
void idGameLocal::StartMapGui_f( const idCmdArgs& args ) {
   idPlayer *player;
   player = gameLocal.GetLocalPlayer();
    player->ToggleMap();
}
